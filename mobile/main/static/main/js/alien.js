var alien = (function(){
	...
	*/
	function AlienGame (node, callback, json) {
		this.frame = node
	...
	AlienGame.prototype = {
		...
		init : function () {
			...
			doors.src = "/static/main/img/alien/salle_alien_up.png";
			doors.id = "doors";
	...
	function Alien (name) {
		...
		this.img = "/static/main/img/alien/alien" + idx + ".png";
	}

	alien.start = function(settings){
		var ag = new AlienGame(settings.node, settings.callback);
	}
